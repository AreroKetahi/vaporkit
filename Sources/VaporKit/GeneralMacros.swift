...
/// the wrapped syntax.
///
/// - Parameter action: The expression to emit without local static checking.
/// - Returns: The value produced by `action`.
@freestanding(expression)
public macro Bypass<T>(_ action: () -> T) -> T = #externalMacro(module: "VaporKitMacros", type: "BypassMacro")
